...
export default function Register() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07070B] px-4 py-10 text-white">

      {/* Background */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-[-220px] h-[500px] w-[700px] -translate-x-1/2 rounded-full bg-[#8B5CF6]/10 blur-[130px]" />

        <div className="absolute bottom-[-250px] right-[-150px] h-[400px] w-[400px] rounded-full bg-[#6366F1]/5 blur-[120px]" />
        ...
        <div className="relative rounded-2xl border border-white/[0.08] bg-[#111116]/90 p-7 shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl">
          ...
          <div className="mb-7">
            ...
            <p className="mt-1.5 text-sm text-gray-500">
              ForBist ile portföyünüzü takip etmeye başlayın.
            </p>
          </div>
